...
def load_input(input_directory):
    ...
    # Se imprime las carpetas del directorio que se ingresa
    # la parte de asterisco es para todos los archivos 
    secuence = []
    filenames = glob.glob(input_directory + "/*")

    with fileinput.input(files = filenames) as f:
        for line in f:
            secuence.append((fileinput.filename(), line))
